...
async function migrateFieldNames() {
  ...
  for (const rating of ratings || []) {
    const fields = rating.solution_fields
...
function aggregateValueField(ratings, fieldName) {
  const valueCounts = {}
...
function aggregateArrayField(ratings, fieldName) {
  const valueCounts = {}
  let ratingsWithField = 0
...
function aggregateBooleanField(ratings, fieldName) {
  const valueCounts = { 'true': 0, 'false': 0 }
  let ratingsWithField = 0
