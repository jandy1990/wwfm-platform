  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        ...
        >
          {/* Header */}
          <div className="sticky top-0 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/10 dark:to-blue-900/10 px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
          ...
          <div className="p-6">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/10 dark:to-blue-900/10 rounded-lg p-4 mb-5">
