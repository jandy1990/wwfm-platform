 ...
 * @see components/templates/HybridBrowse.tsx - Use this instead
 * @see lib/hooks/useGoalSearch.ts - Search logic extracted to hook
 *
 * This file was replaced during a refactor to separate search logic
 * from presentation. Archived November 2025.
 *
 * DO NOT EDIT THIS FILE - it's not used anywhere in the app.
 * The /browse page uses HybridBrowse.tsx instead.
 */
...
export default function SearchableBrowse({ arenas, totalGoals, isLoading = false }: SearchableBrowseProps) {
  ...
  const filteredData = useMemo(() => {
    ...
    setShowDropdown(topSuggestions.length > 0 || trimmedSearch.length >= 3)
          ...
          <div className="relative" ref={searchContainerRef}>
            ...
            <input
              ...
              onFocus={() => {
                ...
                if (filteredData.suggestions?.length > 0 || trimmed.length >= 3) {
            ...
            {showDropdown && (
              <div className="absolute z-10 w-full mt-1 bg-white dark:bg-gray-800 rounded-lg shadow-lg border
                ...
                {filteredData.suggestions?.length > 0 ? (
                  ...
                  // No results message with request button
                  <div className="p-4 text-center">
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">
                      No goals found for &quot;{debouncedSearch.trim()}&quot;
                    </p>
